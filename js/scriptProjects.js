...
var projects = [
    ["3d unity game: ", ["Simple 3d game I made and it was an fps game that I made during highschool. Used unity to make it and vs code programming with C#, I did some cool stuff like adding night vision", "<a href='3dFPS/index.html'>I created the game and you can access it here</a>"]],
    ["2d unity cyberpunk platformer: ", ["I made a game during high school that was a 2d unity cyberpunk themed game as in the genre so the buildings had neon lights, dark city, and oppressive atmosphere but as you got into the building it got surreal in ways with the same room constantly but things changed such as rotation or obstacles", "<a href='unityGames/index.html'>I created the game you can play here</a>"]],
    ["2d walking unity game: ", ["I worked on this one alone using unity and vs code which was c#, I made a cosmic horror themed walking game that was simple with assets I made myself too. I made this in highschool", "<a href='cosmicGameUnity/index.html'>game can be played here</a>"]],
...
//loop through double array to write objects
